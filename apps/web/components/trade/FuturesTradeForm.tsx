    ...
    <div className={cn("flex h-full min-h-0 flex-col bg-card", sheetMode && "rounded-none")}>
      <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-md border border-border bg-background/70 px-2 py-1 text-[10px] font-semibold text-foreground hover:bg-muted"
        >
          ...
          <div className="flex h-full min-h-[220px] items-center justify-center rounded-xl border border-border bg-background/70">
            {isBootstrapping ? (
              <div className="text-center">
                ...
                <p className="text-sm font-semibold text-foreground">Loading default NIFTY future...</p>
                <p className="mt-1 text-xs text-muted-foreground">Preparing contracts and live chart.</p>
              </div>
            ) : (
              <div className="text-center">
              ...
              {availableExpiries.length > 0 && (
                <div className="space-y-1.5">
                  ...
                  <Select value={selectedExpiry} onValueChange={setSelectedExpiry}>
                    <SelectTrigger className="h-8 rounded-md border-border bg-background/80 text-xs">
