  ...
  return (
    <div className={cn("flex h-full min-h-0 flex-col bg-card", sheetMode && "rounded-none")}>
      <div className="flex shrink-0 items-center justify-between border-b border-border px-4 py-3">
        ...
        <button type="button" onClick={onOpenSearch} className="inline-flex items-center gap-1.5 rounded-md border border-border bg-background/70 px-2 py-1 text-[10px] font-semibold text-foreground hover:bg-muted">
        ...
        {!selectedStock ? (
          ...
          <>
              ...
              {availableExpiries.length > 0 && (
                <div className="space-y-1.5">
                  ...
                  <Select value={selectedExpiry} onValueChange={setSelectedExpiry}>
                    <SelectTrigger className="h-8 rounded-md border-border bg-background/80 text-xs"><SelectValue placeholder="Select Expiry" /></SelectTrigger>
            ...
            <div className="grid grid-cols-3 divide-x divide-border overflow-hidden rounded-lg border border-border bg-muted/30">
              <div className="px-3 py-2"><p className="text-[10px] text-muted-foreground">Required</p><p className="mt-0.5 text-xs font-semibold tabular-nums text-foreground">{formatMoney(requiredMargin)}</p></div>
              <div className="px-3 py-2"><p className="text-[10px] text-muted-foreground">Available</p><p className="mt-0.5 text-xs font-semibold tabular-nums text-foreground">{formatMoney(balance)}</p></div>
              <div className="px-3 py-2"><p className="text-[10px] text-muted-foreground">Blocked</p><p className="mt-0.5 text-xs font-semibold tabular-nums text-foreground">{formatMoney(blockedBalance)}</p></div>
            </div>
