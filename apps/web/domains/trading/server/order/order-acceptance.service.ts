...
export class OrderAcceptanceService {
    private static async enforcePaperFullExitRule(
        ...
        if (!Number.isFinite(orderQty) || orderQty > existingAbsQty) {
            throw new ApiError(
                `Cannot sell ${orderQty} units â€” position only has ${existingAbsQty}. Partial exits are allowed but over-sells are not.`,
                400,
     ...
     *   - MIS orders may have leverage 1â€“10.
     ...
     *
     * For a SELL order:
     *   - stopLossPrice must be > reference price (above entry â€” loss if price rises)
     *   - targetPrice   must be < reference price (below entry â€” profit if price falls)
     */
    ...
    static async validateOrder(
        ...
        // â”€â”€ NEW: productType + leverage validation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        // â”€â”€ NEW: SL / Target direction validation (against reference price) â”€â”€
