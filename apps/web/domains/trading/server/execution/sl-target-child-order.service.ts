 ...
 *   When the SL child fires  â†’ TARGET sibling is CANCELLED.
 *   When the TARGET child fires â†’ SL sibling is CANCELLED.
 */
...
export class SlTargetChildOrderService {
    ...
    /**
     * Cancel the sibling child order (OCO â€” one-cancels-other).
