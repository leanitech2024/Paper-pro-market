...
import { feedHealthService } from "@/domains/market/server/feeds/feed-health.service";
...
/** Liquidity availability multiplier â€” allows partial over-fill for paper trading realism */
...
export class FillEngineService {
    ...
    static async resolveFill(order: DbOrder, instrument: Instrument): Promise<FillDecision> {
        ...
        // Feed health guard â€” reject if market data feed is unhealthy
        ...
        // Stale tick guard â€” reject if tick is older than MAX_FILL_TICK_AGE_MS
        ...
        if (order.orderType === "MARKET") {
            ...
            // BUY executes at ask, SELL executes at bid â€” correct market semantics
