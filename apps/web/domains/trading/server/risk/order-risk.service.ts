...
import { TradingSafetyService } from "@/domains/trading/server/risk/trading-safety.service";
import { PreTradeRiskService } from "@/domains/trading/server/risk/pretrade-risk.service";
...
export class OrderRiskService {
  ...
  static async checkRiskLimits(
    ...
    if (!DISABLE_NOTIONAL_CAP && orderNotional > maxNotional) {
