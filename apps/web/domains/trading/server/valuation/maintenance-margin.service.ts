...
export class MaintenanceMarginService {
...
declare global {
    var __maintenanceMarginServiceInstance: MaintenanceMarginService | undefined;
}

const globalState = globalThis as unknown as { __maintenanceMarginServiceInstance?: MaintenanceMarginService };
export const maintenanceMarginService = globalState.__maintenanceMarginServiceInstance || new MaintenanceMarginService();

globalState.__maintenanceMarginServiceInstance = maintenanceMarginService;
