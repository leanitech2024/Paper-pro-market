...
import { getTrendLabel, getVolatilityLabel } from "@/domains/trading/lib/options/option-hints";
import { computeMarketContext, getExpiryModeBanner } from "@/domains/trading/lib/options/market-context";
...
const TREND_ICONS = { UP: "â–²", DOWN: "â–¼", SIDEWAYS: "â†’" };
