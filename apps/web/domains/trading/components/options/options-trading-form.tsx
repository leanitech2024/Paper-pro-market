...
import { useTradeExecutionStore } from '@/domains/trading/stores/tradeExecution.store';
...
import { useInstrumentPrice } from '@/domains/market/hooks/useInstrumentPrice';
import { useMarginPreview } from '@/domains/trading/hooks/useMarginPreview';
import { getExitQuantity } from '@/utils/trading/position-exit';

import { TradePriceDisplay } from '@/components/shared/trade/trade-price-display';
import { TradeMarginSummary, formatMoney } from '@/components/shared/trade/trade-margin-summary';
import { TradeControls } from '@/components/shared/trade/trade-controls';
import { parseExpiryDate, toExpiryIso } from '@/components/shared/trade/utils';
import { InstrumentSelector, InstrumentType } from '@/domains/trading/components/form/InstrumentSelector';
import { StockSearch, OrderTypeToggle, OrderProcessingDialog, TradeConfirmationDialog, OptionsRiskMetrics, OptionsPayoffChart } from '@/domains/trading/components/form';
