...
import { toInstrumentKey, ensureBidAsk } from "@paper-market/core";
import {
  feedHealthService,
  recordFeedPrice,
} from "@/domains/market/server/feeds/feed-health.service";
import { tickBus } from "@paper-market/core";
import type { NormalizedTick } from "@paper-market/core";

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// ðŸ› ï¸ SINGLETON PATTERN: Global declaration for Next.js hot reload
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
declare global {
...
class RealTimeMarketService {
  ...
  private quoteCleanupInterval: NodeJS.Timeout | null = null;
  private readonly QUOTE_CLEANUP_INTERVAL_MS = 10 * 60 * 1000; // 10 minutes

  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // ðŸ› ï¸ PRIVATE CONSTRUCTOR
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  private constructor() {}

  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // ðŸ› ï¸ SINGLETON ACCESSOR
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // ðŸ”Œ INITIALIZE: Connect to market-engine WS
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // ðŸ”Œ CONNECT to market-engine WebSocket
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  // ðŸ“¨ HANDLE INCOMING TICK MESSAGE
  // â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  private handleMessage(raw: WebSocket.RawData): void {
    ...
    if (msg.type === "tick" && msg.data && typeof msg.data === "object") {
      ...
      // Control / status messages â€” nothing to do
      return;
  ...
  private parseTick(
    ...
    const rawBid = Number.isFinite(Number(obj.bid)) ? Number(obj.bid) : undefined;
    const rawAsk = Number.isFinite(Number(obj.ask)) ? Number(obj.ask) : undefined;
    const { bid, ask } = ensureBidAsk(price, rawBid, rawAsk);
    ...
    return {
      ...
      bid,
      ask,
      bidQty: Number.isFinite(Number(obj.bidQty)) ? Number(obj.bidQty) : undefined,
      askQty: Number.isFinite(Number(obj.askQty)) ? Number(obj.askQty) : undefined,
  ...
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  // PUBLIC API â€” unchanged signatures
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
  ...
  getQuote(symbol: string): Quote | null {
    ...
    // Try instrumentKey first (most common path â€” avoids Map indirection)
  ...
  /**
   * Garbage-collect quote maps by removing instruments with zero subscribers.
   * Prevents unbounded map growth during long sessions with many instruments.
   * Runs every 10 minutes.
   */
  private startQuoteCleanupLoop(): void {
    if (this.quoteCleanupInterval) return;
    this.quoteCleanupInterval = setInterval(() => {
      this.cleanupStaleQuotes();
    }, this.QUOTE_CLEANUP_INTERVAL_MS);
  }

  private cleanupStaleQuotes(): void {
    let removed = 0;
    for (const [key, quote] of this.quotesByInstrument.entries()) {
      const subCount = this.subscribers.get(key) ?? 0;
      if (subCount > 0) continue;
      this.quotesByInstrument.delete(key);
      this.prices.delete(key);
      this.prices.delete(quote.symbol);
      this.symbolToQuote.delete(quote.symbol.toUpperCase());
      removed++;
    }
    if (removed > 0) {
      logger.info({ removed }, "RealTimeMarketService: cleaned up stale quotes");
    }
  }
}

// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// ðŸ› ï¸ EXPORT SINGLETON INSTANCE
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
