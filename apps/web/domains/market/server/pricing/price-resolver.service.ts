...
/** Maximum number of entries in the resolver cache â€“ oldest evicted when exceeded */
...
export class PriceResolverService {
  ...
  static async resolvePrice(
    ...
    // No price available from any source â€” return NO_PRICE_AVAILABLE marker.
  ...
  private static setCached(key: string, entry: CacheEntry): void {
    if (this.cache.size >= MAX_CACHE_SIZE) {
      // Map iteration order is insertion order â€” delete oldest first
