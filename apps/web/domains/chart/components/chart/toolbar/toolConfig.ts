...
export const TOOL_BUTTON_SIZE_CLASS = "w-[34px] h-[34px]";
export const TOOLTIP_CLASS =
  "fixed z-[9999] pointer-events-none rounded-md bg-white/95 px-2.5 py-1.5 text-[10px] font-medium text-slate-700 shadow-xl border border-slate-200/80 whitespace-nowrap dark:bg-[#0c1322]/95 dark:text-slate-200 dark:border-white/[0.15] backdrop-blur-md";
export const EXPAND_BUTTON_CLASS =
  "absolute left-full top-1/2 -translate-y-1/2 w-4 h-6 flex items-center justify-center text-slate-400/50 hover:text-slate-100 transition-colors z-20";
...
export const ACTION_GROUPS: ToolGroup[] = [
  {
    name: "Eraser",
    tools: [{ id: "eraser", label: "Eraser", icon: "eraser" }],
  },
  {
    name: "Lock",
    tools: [{ id: "lock", label: "Lock All Drawings", icon: "lock" }],
  },
  {
    name: "Clear",
    tools: [{ id: "clear", label: "Clear All Drawings", icon: "trash2" }],
  },
  {
    name: "Hide",
    tools: [{ id: "hide", label: "Hide Options", icon: "eye" }],
  },
];
