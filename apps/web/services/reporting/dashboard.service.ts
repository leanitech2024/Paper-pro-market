...
export class DashboardService {
  static async getOverview(userId: string): Promise<DashboardOverviewData> {
    ...
    // Previously fetched ALL transactions sorted by date — for active traders
    ...
    // Equity curve is fetched descending for recency cap — reverse for chronological charts
    const equityCurve =
      equityRows.length > 0
