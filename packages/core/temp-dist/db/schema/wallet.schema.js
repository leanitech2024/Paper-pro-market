import { pgTable, uuid, numeric, varchar, timestamp, text, pgEnum, uniqueIndex, } from 'drizzle-orm/pg-core';
...
export const transactions = pgTable('transactions', {
    ...
    uniqueRef: uniqueIndex('wallet_txn_unique_ref').on(table.userId, table.type, table.referenceType, table.referenceId),
}));
