import { bigserial, index, jsonb, pgEnum, pgTable, text, timestamp, uniqueIndex, uuid, } from "drizzle-orm/pg-core";
...
export const writeAheadJournal = pgTable("write_ahead_journal", {
