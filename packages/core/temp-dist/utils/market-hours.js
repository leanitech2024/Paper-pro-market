const HOLIDAY_ENV_KEYS = ["NSE_TRADING_HOLIDAYS_IST", "NSE_CLOSED_DATES_IST"];
...
export function isTradingHolidayIST(now = new Date()) {
 ...
 */
export function isMarketOpenIST(now = new Date()) {
