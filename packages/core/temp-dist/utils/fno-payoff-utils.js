 ...
 */
export function generateCallPayoff({ strikePrice, premium, lotSize, numberOfLots, rangeConfig }) {
 ...
 */
export function generatePutPayoff({ strikePrice, premium, lotSize, numberOfLots, rangeConfig }) {
    const totalQuantity = lotSize * numberOfLots;
