 ...
 */
export function calculateOptionRiskMetrics(entryPrice, // Premium
quantity, // Number of lots (or raw qty if lotSize is handled outside)
_lotSize, optionDetails, side) {
    if (!optionDetails)
        return null;
