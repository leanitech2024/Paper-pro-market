 ...
 */
export declare function ensureBidAsk(price: number, bid: number | undefined, ask: number | undefined, spreadBps?: number): {
    bid: number;
    ask: number;
};
/**
...
export interface MarketDataProvider {
    ...
    getHistoricalCandles(symbol: string, interval: string, range: {
        start: Date;
        end: Date;
    }): Promise<Candle[]>;
}
